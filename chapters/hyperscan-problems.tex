...
\begin{figure}[htbp]
  ...
  \end{tikzpicture}
  \caption{Proposed sequential dependency graph representation for \texttt{abc[0-9]+xyz}. \cyril{I'm a bit confuse by the edge $abc\rightarrow xyz$}}
...
Suppose that the regex trees are generated according to a BST-like distribution. The average length of the longest literals of an $n$-node tree satisfies the recurrence \cyril{explain why this equation holds, at least informally}
\begin{equation}
